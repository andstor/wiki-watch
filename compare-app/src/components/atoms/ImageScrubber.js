...
import { setScrubberPosition } from '../../actions';
...
class ImageScrubber extends React.Component {
  constructor (props) {
    super(props);
    this.state = {
  ...
  onChange(position) {
    this.props.setScrubberPosition(position)
  }
  ...
  render () {
    ...
    console.log("showIsolatedTestImage", showIsolatedTestImage)
        ...
        <Wrapper>
          ...
          >
            ...
            <TwentyTwenty
              ...
              left={<img id="scrubberRefImage" className="refImage" src={refImage} onError={this.handleRefImageLoadingError}/>}
              right={<img id="scrubberTestImage" className="testImage" src={scrubberTestImageSlug}/>}
              slider={<SliderBar className="slider" />}
            />
          </div>
        </Wrapper>
      </div>
...
const mapDispatchToProps = dispatch => {
  return {
    setScrubberPosition: (pos) => {
      dispatch(setScrubberPosition(pos));
    }
  }
}

export default connect(null, mapDispatchToProps)(ImageScrubber);
